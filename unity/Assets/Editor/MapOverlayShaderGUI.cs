...
namespace EconSim.Editor
{
    public class MapOverlayShaderGUI : ShaderGUI
    {
        ...
        private static readonly (string name, string label)[] RealmRenderingProps = new[]
        {
            ...
            ("_HeightmapOpacity", "Heightmap Opacity"),
            ("_HeightLevelsInBlack", "Height Levels Input Black"),
            ("_HeightLevelsInWhite", "Height Levels Input White"),
            ("_HeightLevelsGamma", "Height Levels Gamma"),
            ("_HeightLevelsOutBlack", "Height Levels Output Black"),
            ("_HeightLevelsOutWhite", "Height Levels Output White"),
