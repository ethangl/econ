...
float3 ComputeWater(bool isCellWater, float height, float riverMask, float2 worldUV, float3 underlyingColor)
{
    ...
    if (isCellWater)
    {
        ...
        float3 attenuatedUnderlying = underlyingColor * transmittance;
