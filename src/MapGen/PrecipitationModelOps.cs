...
{
    /// <summary>
    /// Precipitation via wind-band sweeps, emitted as mm/year.
    /// </summary>
    public static class PrecipitationModelOps
    {
        ...
        static float[] SweepBand(CellMesh mesh, ElevationField elevation, ClimateField climate, Vec2 windDir, MapGenConfig config)
        {
            int n = mesh.CellCount;
