...
namespace MapGen.Core
{
    ...
    public static class LegacyExportOps
    {
        ...
        {
            new BiomeCatalogEntry { Id = 0,  Name = "Glacier",             Color = new Rgba32(220, 235, 250, 255) },
            new BiomeCatalogEntry { Id = 1,  Name = "Tundra",              Color = new Rgba32(180, 210, 200, 255) },
            new BiomeCatalogEntry { Id = 2,  Name = "Salt Flat",           Color = new Rgba32(230, 220, 200, 255) },
            new BiomeCatalogEntry { Id = 3,  Name = "Coastal Marsh",       Color = new Rgba32(140, 175, 140, 255) },
            new BiomeCatalogEntry { Id = 4,  Name = "Alpine Barren",       Color = new Rgba32(170, 170, 170, 255) },
            new BiomeCatalogEntry { Id = 5,  Name = "Mountain Shrub",      Color = new Rgba32(140, 160, 120, 255) },
            new BiomeCatalogEntry { Id = 6,  Name = "Floodplain",          Color = new Rgba32(90,  160, 70,  255) },
            new BiomeCatalogEntry { Id = 7,  Name = "Wetland",             Color = new Rgba32(100, 150, 120, 255) },
            new BiomeCatalogEntry { Id = 8,  Name = "Hot Desert",          Color = new Rgba32(220, 200, 140, 255) },
            new BiomeCatalogEntry { Id = 9,  Name = "Cold Desert",         Color = new Rgba32(200, 195, 170, 255) },
            new BiomeCatalogEntry { Id = 10, Name = "Scrubland",           Color = new Rgba32(180, 180, 100, 255) },
            new BiomeCatalogEntry { Id = 11, Name = "Tropical Rainforest", Color = new Rgba32(40,  120, 40,  255) },
            new BiomeCatalogEntry { Id = 12, Name = "Tropical Dry Forest", Color = new Rgba32(100, 140, 60,  255) },
            new BiomeCatalogEntry { Id = 13, Name = "Savanna",             Color = new Rgba32(170, 180, 80,  255) },
            new BiomeCatalogEntry { Id = 14, Name = "Boreal Forest",       Color = new Rgba32(70,  110, 80,  255) },
            new BiomeCatalogEntry { Id = 15, Name = "Temperate Forest",    Color = new Rgba32(60,  140, 60,  255) },
            new BiomeCatalogEntry { Id = 16, Name = "Grassland",           Color = new Rgba32(150, 190, 90,  255) },
            new BiomeCatalogEntry { Id = 17, Name = "Woodland",            Color = new Rgba32(90,  150, 70,  255) },
            new BiomeCatalogEntry { Id = 18, Name = "Lake",                Color = new Rgba32(80,  130, 190, 255) },
        };
