...
namespace WorldGen.Core
{
    ...
    public static class WindOps
    {
        ...
        static Vec3 InterpolateDirection(Vec3 a, Vec3 b, float t)
        {
            t = Math.Clamp(t, 0f, 1f);

            // Let opposing belts relax through calm flow instead of rotating
            // through an arbitrary cross-belt heading.
            return a * (1f - t) + b * t;
        }
