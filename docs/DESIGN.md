...
- [x] Parse Azgaar JSON format
- [x] Extract heightmap, cells, regions, rivers
- [x] Generate 3D terrain mesh in Unity
- [x] Render political boundaries (state + province borders)
- [x] Camera controls (pan, zoom, spacebar drag)
- [x] Map mode switching (1-4 keys)
- [x] Validate rendering against Azgaar SVG export

### Phase 1.5: Architecture Refactor ✓

- [x] Create `src/EconSim.Core/` as standalone C# project (netstandard2.1)
- [x] Custom Vec2/Color32 types (no Unity dependency)
- [x] Move Import code (AzgaarParser, MapConverter) to Core
...
- [x] N:1 cell-to-county relationship
...
- [x] Gradient fill for political modes (state/province/county)
